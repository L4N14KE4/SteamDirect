...
### 활성화<code style="color : #3498DB">(파란색)</code>
Steam 서비스(Steam store, Community, Steam Chat) 접속시 파란색 아이콘이 표시됩니다.</br>

### 비활성화<code style="color : orangered">(붉은색)</code>
...
### 1. 알림<code style="color : #3498DB">(Notice)</code>
...
---
### 2. 링크차단<code style="color : orangered">(Link Blocked!)</code>
