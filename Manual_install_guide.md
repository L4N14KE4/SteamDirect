...
## 목차
1. [다운로드](#1-다운로드)</br>
2. [확장 프로그램 페이지 이동](#2-확장-프로그램-페이지-이동)</br>
3. [개발자 모드 활성화](#3-개발자-모드-활성화)</br>
4. [압축 해제된 확장 프로그램 로드](#4-압축-해제된-확장-프로그램-로드)</br>
5. [확장 프로그램 고정](#5-확장-프로그램-고정)</br>
...
<img src="./imgs/install_drag.gif" width="60%" height="60%" alt="알림"></br>
</br>
